...
*/
		CZipException(int iCause = generic, const char* lpszZipName = NULL);
...
*/
	...
	static void Throw(int iZipError = CZipException::generic, const char* lpszZipName = NULL)
	{
		#ifdef _MFC_VER
...
*/
     ...
     */
	int32_t GetErrorMessage(char* lpszError, uint32_t nMaxError, uint32_t* = NULL);
