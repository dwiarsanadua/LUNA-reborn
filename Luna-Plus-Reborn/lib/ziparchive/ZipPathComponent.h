...
public:
	...
	static const char m_cSeparator; ///< A system - specific default path separator. Defined in ZipPlatform.cpp.
/**
...
/**
	...
	\see SetFullPath
*/
	CZipPathComponent(const char* lpszFullPath)
	{
...
*/
	void SetFullPath(const char* lpszFullPath);
...
/**
	...
	\return	
*/
	void SetFileTitle(const char* lpszFileTitle) { m_szFileTitle = lpszFileTitle;}
...
*/
	void SetExtension(const char* lpszExt) 
	{
		m_szFileExt = lpszExt;
