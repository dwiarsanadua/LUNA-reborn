...
//				CPlex	class									//
//////////////////////////////////////////////////////////////////
CPlex* PASCAL CPlex::Create(CPlex*& pHead, uint32_t nMax, uint32_t cbElement)
{
...
int32_t cPtrList::Remove(void* pRemoveValue)
{
