# Agent #008 — Tugas Adaptasi Luna Old → Reborn
...
### game/ecs/systems/AISystem.cpp [UPDATE]

- **🟡 Aggro system (damage-based)** (Severity: H, Effort: 5 days)
  - Referensi Old: `Hero.cpp`

- **🔴 Aggro reset on target death** (Severity: M, Effort: 2 days)
  - Referensi Old: `Hero.cpp`

### client/ui/UiScriptParser.cpp [UPDATE]

- **🟡 .bin UI script: parse remaining layouts** (Severity: H, Effort: 2 wks)
  - Referensi Old: `.bin (UI script)`
