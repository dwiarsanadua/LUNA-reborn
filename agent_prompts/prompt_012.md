# Agent #012 — Tugas Adaptasi Luna Old → Reborn
...
- **🟡 Map change failure rollback** (Severity: M, Effort: 2 days)
  - Referensi Old: `Rollback to previous map`

- **🟡 MAP->CollisionLine implementation** (Severity: H, Effort: 5 days)
  - Referensi Old: `MAP->CollisionLine()`

### server/map/systems/CombatSystem.cpp [UPDATE]

- **🟡 MapServer: combat system** (Severity: H, Effort: 5 days)
  - Referensi Old: `Hero.cpp server logic`
