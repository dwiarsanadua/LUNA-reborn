# Agent #021 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/GuildMarkDialog.cpp [BARU]

- **🟡 GuildMark dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `GuildMark.bin`

### engine/gx_render/Texture.cpp [UPDATE]

- **🟡 Asset load fallback texture** (Severity: M, Effort: 1 day)
  - Referensi Old: `Fallback texture + log`
