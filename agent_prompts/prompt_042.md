# Agent #042 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/FarmUpgradeDialog.cpp [BARU]

- **🔴 FarmUpgrade dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `Farm_Upgrade.bin`
