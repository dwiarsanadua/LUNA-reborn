# Agent #017 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/screens/CharSelectScreen.cpp [UPDATE]

- **🔴 Character delete** (Severity: M, Effort: 2 days)
  - Referensi Old: `CharSelect.bin`

### server/map/systems/PartySystem.cpp [UPDATE]

- **🟡 MapServer: party manager** (Severity: M, Effort: 3 days)
  - Referensi Old: `(PartyManager)`
