# Agent #018 — Tugas Adaptasi Luna Old → Reborn
...
### client/rendering/CharacterRenderer.cpp [UPDATE]

- **🟡 3D char preview** (Severity: M, Effort: 3 days)
  - Referensi Old: `CharSelect.bin`

### server/map/systems/GuildSystem.cpp [UPDATE]

- **🟡 MapServer: guild manager** (Severity: M, Effort: 1 week)
  - Referensi Old: `(GuildManager)`
