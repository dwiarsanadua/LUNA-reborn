# Agent #015 — Tugas Adaptasi Luna Old → Reborn
...
### PatchSystem.cpp [UPDATE]

- **🟡 Launcher patch download** (Severity: H, Effort: 3 days)
  - Referensi Old: `MainDialog.cpp`

### server/map/systems/SpawnSystem.cpp [UPDATE]

- **🟡 MapServer: monster spawn** (Severity: M, Effort: 5 days)
  - Referensi Old: `(MonsterManager)`
