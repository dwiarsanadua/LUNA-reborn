# Agent #019 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/SkillTrnDialog.cpp [BARU]

- **🔴 SkillTrn dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `SkillTrn.bin`

### server/distribute/ChannelManager.cpp [BARU]

- **🟡 DistributeServer: channel management** (Severity: M, Effort: 3 days)
  - Referensi Old: `(ChannelManager)`
