# Agent #034 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/ConsignmentDialog.cpp [BARU]

- **🔴 ConsignmentCategory dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `ConsignmentCategory.bin`
