# Agent #033 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/ComposeDialog.cpp [BARU]

- **🔴 Compose dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `ComposeDialog.bin`
