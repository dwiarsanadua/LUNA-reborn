# Agent #020 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/PartySetDialog.cpp [BARU]

- **🔴 PartySet dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `PartySet.bin`

### client/network/NetworkClient.cpp [UPDATE]

- **🔴 Network reconnect dialog** (Severity: H, Effort: 3 days)
  - Referensi Old: `Reconnect dialog 10s`
