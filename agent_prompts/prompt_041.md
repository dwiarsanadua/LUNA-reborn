# Agent #041 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/HousingDialog.cpp [BARU]

- **🔴 HousingWarehouse dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `HousingWarehouseDlg.bin`
