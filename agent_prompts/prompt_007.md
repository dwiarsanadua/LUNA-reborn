# Agent #007 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/StreetStallDialog.cpp [BARU]

- **🟡 StreetStall buy** (Severity: M, Effort: 3 days)
  - Referensi Old: `StallBuy.bin`

- **🟡 StreetStall sell** (Severity: M, Effort: 3 days)
  - Referensi Old: `StallSell.bin`

### client/ui/UiAtlasRegistry.cpp [UPDATE]

- **🟡 .spr sprite → atlas wiring** (Severity: M, Effort: 3 days)
  - Referensi Old: `.spr (sprite)`
