# Agent #025 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/NPCDialog.cpp [BARU]

- **🟡 NPCShop integration** (Severity: M, Effort: 2 days)
  - Referensi Old: `NPCShop.bin`

### client/ui/UiStringTable.cpp [UPDATE]

- **🟡 String table full coverage** (Severity: H, Effort: 1 week)
  - Referensi Old: `InterfaceMsg.bin`
