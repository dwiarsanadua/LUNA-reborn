# Agent #027 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/TargetMonsterDialog.cpp [BARU]

- **🔴 TargetMonster dialog** (Severity: M, Effort: 1 day)
  - Referensi Old: `TargetMonster.bin`

### config/Localization.cpp [UPDATE]

- **🟡 Language switching wire** (Severity: M, Effort: 3 days)
  - Referensi Old: `Runtime language change`
