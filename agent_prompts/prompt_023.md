# Agent #023 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/GuildBankDialog.cpp [BARU]

- **🟡 GuildBank dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `Guildbank.bin`

### engine/gx_render/VFS.cpp [UPDATE]

- **🔴 File not found fallback asset** (Severity: M, Effort: 3 days)
  - Referensi Old: `Fallback asset + dialog`
