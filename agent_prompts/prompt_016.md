# Agent #016 — Tugas Adaptasi Luna Old → Reborn
...
- **🔴 HTML notice view** (Severity: L, Effort: 1 day)
  - Referensi Old: `MainDialog.cpp`

### server/map/systems/QuestSystem.cpp [UPDATE]

- **🟡 MapServer: quest manager** (Severity: M, Effort: 5 days)
  - Referensi Old: `(QuestManager)`
