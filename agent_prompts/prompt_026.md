# Agent #026 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/TargetDialog.cpp [BARU]

- **🟡 Target UI placeholder** (Severity: M, Effort: 2 days)
  - Referensi Old: `Target.bin`

### client/rendering/UIRenderer.cpp [UPDATE]

- **🔴 CJK font support** (Severity: H, Effort: 3 days)
  - Referensi Old: `Per-language fonts`
