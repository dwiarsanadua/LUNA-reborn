# Agent #031 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/FishingDialog.cpp [BARU]

- **🔴 FishingPoint dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `FishingPointDlg.bin`
