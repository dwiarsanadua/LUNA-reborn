# Agent #022 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/GuildWarehouseDialog.cpp [BARU]

- **🟡 GuildWarehouse dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `GuildWarehouse.bin`

### client/gameobjects/PersistenceManager.cpp [UPDATE]

- **🔴 Character load failure dialog** (Severity: M, Effort: 2 days)
  - Referensi Old: `Retry + error dialog`
