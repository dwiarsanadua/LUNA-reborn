# Agent #028 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/TargetCharacterDialog.cpp [BARU]

- **🔴 TargetCharacter dialog** (Severity: M, Effort: 1 day)
  - Referensi Old: `TargetCharacter.bin`

### client/ui/UiSoundIndex.cpp [UPDATE]

- **🟡 SFX list full loading** (Severity: M, Effort: 2 days)
  - Referensi Old: `SoundList.bin.txt`
