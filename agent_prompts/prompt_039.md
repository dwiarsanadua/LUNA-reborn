# Agent #039 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/FamilyDialog.cpp [BARU]

- **🔴 FamilyInvite dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `FamilyInvite.bin`
