# Agent #040 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/FamilyMarkDialog.cpp [BARU]

- **🔴 FamilyMark dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `FamilyMark.bin`
