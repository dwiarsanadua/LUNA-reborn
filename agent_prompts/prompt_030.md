# Agent #030 — Tugas Adaptasi Luna Old → Reborn
...
### client/ui/dialogs/StallOptionDialog.cpp [BARU]

- **🔴 StallOption dialog** (Severity: L, Effort: 1 day)
  - Referensi Old: `StallOption.bin`
