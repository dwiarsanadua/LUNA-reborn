# Agent #014 — Tugas Adaptasi Luna Old → Reborn
...
### engine/physics/PhysicsWorld.cpp [UPDATE]

- **🔴 CollisionTestMovingSphereMeetTriangle** (Severity: M, Effort: 1 week)
  - Referensi Old: `(proprietary)`

- **🔴 AAEllipsoidCollisionTest** (Severity: M, Effort: 1 week)
  - Referensi Old: `(proprietary)`

### server/map/systems/AISystem.cpp [UPDATE]

- **🟡 MapServer: NPC/AI system** (Severity: M, Effort: 1 week)
  - Referensi Old: `(NPC manager)`
